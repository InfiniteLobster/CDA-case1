...
def build_pipeline(names_num_cols:list, names_cat_cols:list, flag_scale:bool, num_strat:str, cat_strat:str, model_name:str, model_params:DictConfig):
...
def build_pipeline_cfg(names_num_cols, names_cat_cols,cfg_preprocess:DictConfig, cfg_model:DictConfig):
    #retriving parameters (informations) of preprocess from subconfig (from main config, structured like that for logical orgnization of code and configs)
